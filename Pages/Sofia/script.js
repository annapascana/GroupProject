(() => {
  // Default groups data
  const defaultGroups = [
    { id: 1, name: 'MIS321 Exam Prep', course: 'MIS321', size: '4-6', time: 'evening', location: 'library', focus: 'exam-prep', desc: 'Review sessions and practice exams.', specific: 'Library 3A', members: 4, max: 6 },
    { id: 2, name: 'CS101 Homework Help', course: 'CS101', size: '2-3', time: 'afternoon', location: 'campus', focus: 'homework-help', desc: 'Weekly problem set support.', specific: 'Comp Lab B', members: 2, max: 3 },
    { id: 3, name: 'MATH200 Concepts', course: 'MATH200', size: '7-10', time: 'morning', location: 'campus', focus: 'concept-review', desc: 'Core concepts and proofs.', specific: 'Math 205', members: 8, max: 10 },
    { id: 4, name: 'ENG101 Peer Review', course: 'ENG101', size: '4-6', time: 'afternoon', location: 'online', focus: 'homework-help', desc: 'Essay critique and writing tips.', specific: 'Zoom', members: 5, max: 6 },
    { id: 5, name: 'CHEM101 Study Buddy', course: 'CHEM101', size: '2-3', time: 'evening', location: 'coffee-shop', focus: 'study-buddy', desc: 'Light sessions + flashcards.', specific: 'Starbucks Main', members: 1, max: 3 }
  ];
  ...
  function render(items) {
    ...
    els.list.querySelectorAll('[data-join]').forEach(btn => btn.addEventListener('click', () => join(parseInt(btn.dataset.join,10))));
        ...
        <div class="card-body">
          <div class="d-flex flex-column flex-md-row justify-content-between gap-3">
            <div class="flex-grow-1">
              <h5 class="mb-2"><i class="bi bi-people-fill me-2 text-primary"></i>${escapeHtml(g.name)}</h5>
  ...
  function createGroup(){
    ...
    groups.unshift({ id: Date.now(), name, course, size, time, location, focus, desc, specific, members:1, max });
